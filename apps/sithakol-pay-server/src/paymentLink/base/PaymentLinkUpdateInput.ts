...
class PaymentLinkUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => TransactionUpdateManyWithoutPaymentLinksInput,
  })
  @ValidateNested()
  @Type(() => TransactionUpdateManyWithoutPaymentLinksInput)
  @IsOptional()
  @Field(() => TransactionUpdateManyWithoutPaymentLinksInput, {
    nullable: true,
  })
...
export { PaymentLinkUpdateInput as PaymentLinkUpdateInput };
