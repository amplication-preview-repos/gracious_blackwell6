...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.createTransaction({
      ...
      data: {
        ...
        paymentLink: args.data.paymentLink
          ? {
              connect: args.data.paymentLink,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => PaymentLink, {
    nullable: true,
    name: "paymentLink",
  })
  @nestAccessControl.UseRoles({
  ...
  async getPaymentLink(
    ...
    const result = await this.service.getPaymentLink(parent.id);
  ...
  @graphql.Mutation(() => TransactionWhereUniqueInput)
  async PayLink(
    @graphql.Args()
    args: TransactionCreateInput
  ): Promise<TransactionWhereUniqueInput> {
    return this.service.PayLink(args);
  }
}
