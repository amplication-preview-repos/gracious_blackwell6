...
@InputType()
class TransactionUpdateManyWithoutPaymentLinksInput {
...
export { TransactionUpdateManyWithoutPaymentLinksInput as TransactionUpdateManyWithoutPaymentLinksInput };
